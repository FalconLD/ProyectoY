...
# Reemplaza SOLO la función reserva en tu views.py con esta versión de diagnóstico
...
def reserva(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # =============================================================
            # LÍNEA DE DIAGNÓSTICO: Esto nos dirá qué está mal.
